...
let BusService = class BusService {
    constructor(busModel, busRouteModel) {
...
exports.BusService = BusService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(bus_entity_1.Bus.name)),
    __param(1, (0, mongoose_1.InjectModel)(bus_route_entity_1.BusRoute.name)),
